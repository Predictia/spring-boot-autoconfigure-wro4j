...
public class WroContextSupport implements ServletContextAware {
	...
	public WroManagerFactory getWroManagerFactory() {
	 ...
	 */
	public <T> T doInContext(HttpServletRequest request, HttpServletResponse response, ContextTemplate<T> template) {
	 ...
	 * @see Context
	 */
	public boolean setContext(HttpServletRequest request, HttpServletResponse response) {
